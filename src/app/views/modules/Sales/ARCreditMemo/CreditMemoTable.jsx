...
//edit this function
 ...
 //edit this function
  const handleInputChange = useCallback((lineNum, event) => {
    ...
    console.log("handleInputChange :", props.RIN1);
  }, [props.setRIN1]);
...
const handleDelete = (index) => {
  ...
  const updatedRIN1 = [...props.RIN1];
  updatedRIN1.splice(index, 1); // Remove the selected row
  props.setRIN1(updatedRIN1); // Update the state with the new list
...
const handleEdit = (index, fieldName) => {
  ...
  if (props.RIN1[index].isEditing || props.state.Mode !== "Créer") {
    return;
  }

  if (props.allFieldsFilled()) {
    const updatedRows = props.RIN1.map((row, rowIndex) => ({
      ...row,
      isEditing: rowIndex === index
    }));
    props.setRIN1(updatedRows);
          ...
          <FormControlLabel
            control={
              <Checkbox
                ...
                disabled={
                  props.selectedField.name === "ItemCode" &&
                  props.RIN1[props.selectedField.index] &&
                  props.RIN1[props.selectedField.index].ItemCode &&
