// frontend/src/components/SalesQuotationForm.js
...
import SalesQuotationTable from "./SalesQuotationTable"; // Import custom component to handle the delivery table
...
// SalesQuotationForm component definition
const SalesQuotationForm = (props) => {
  ...
  useEffect(() => {
    if (!props.OqutData.DocStatus.trim()) {
      props.setOqutData((prevFormData) => ({
        ...prevFormData,
        DocStatus: "O", // Default status is 'O' (Open)
      }));
    }
  }, [props.OqutData.DocStatus, props.setOqutData]);
          ...
          <Grid item lg={4} md={6} sm={12} xs={12}>
            ...
            >
              ...
              <Select
                ...
                name="DocStatus"
                size="small"
                value={props.OqutData.DocStatus.trim() || "O"}
                onChange={props.handleChange}
                style={{ width: "100%" }}
                inputProps={{ readOnly: true }}
              >
          ...
          <Grid item lg={4} md={6} sm={12} xs={12}> {/* Flatpickr DocDate */}
              <div style={{ position: "relative", width: "100%" }}>
                  <Flatpickr
                      ...
                      value={props.OqutData.DocDate ? new Date(props.OqutData.DocDate) : new Date()}
                  ...
                  />
                  <label className="label-flatpickr" style={{top: props.OqutData.DocDate ? "-10px" : "12px"}} > Date Document </label>
              </div>
          </Grid>
          <Grid item lg={4} md={6} sm={12} xs={12}>
              <div style={{ position: "relative", width: "100%" }}>
                  <Flatpickr
                      className="Flatpickr-flatpickr"
                      data-enable-time={false}
                      value={props.OqutData.DueDate ? new Date(props.OqutData.DueDate) : new Date()}
                      onChange={(date) => props.handleChange({  target: { name: "DueDate", value: date[0] }, }) }
                      options={{ dateFormat: "d/m/Y"}}
                      disabled={props.state.Mode === "Mettre à jour" || props.state.Mode === "OK"}
                  />
                  <label className="label-flatpickr" style={{top: props.OqutData.DueDate ? "-10px" : "12px"}} > Date d'écheance </label>
              </div>
          </Grid>
        </Grid>
        {/* SalesQuotationTable component for managing delivery lines */}
        <SalesQuotationTable
          ...
          Qut1Data={props.Qut1Data}
          setQut1Data={props.setQut1Data}
          Mode={props.Mode}
          setOqutData={props.setOqutData}
          state={props.state}
              ...
              <Grid container>
                <Grid item lg={2} md={6} sm={12} xs={12}>
                  <StyledTextField
                    ...
                    type="text"
                    name="DiscPrcnt"
                    value={props.OqutData.DiscPrcnt}
                    onChange={props.handleChange}
                ...
                <Grid item lg={9} md={6} sm={12} xs={12}>
                  <StyledTextField
                    ...
                    type="text"
                    name="RemiseTotal"
                    value={props.OqutData.RemiseTotal}
                    onChange={props.handleChange}
                    onBlur={() => props.handleCalculations2()} 
                    label="Total Remise"
                    fullWidth
