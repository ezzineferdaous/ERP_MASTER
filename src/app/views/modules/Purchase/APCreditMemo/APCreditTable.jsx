...
//edit this function
 ...
 //edit this function
  const handleInputChange = useCallback((lineNum, event) => {
    ...
    console.log("handleInputChange :", props.RPC1);
  }, [props.setRPC1]);
...
const handleEdit = (index, fieldName) => {
  ...
  if (props.RPC1[index].isEditing || props.state.Mode !== "Créer") {
    return;
  }

  if (props.allFieldsFilled()) {
    const updatedRows = props.RPC1.map((row, rowIndex) => ({
      ...row,
      isEditing: rowIndex === index
    }));
    props.setRPC1(updatedRows);
          ...
          <FormControlLabel
            control={
              <Checkbox
                ...
                disabled={
                  props.selectedField.name === "ItemCode" &&
                  props.RPC1[props.selectedField.index] &&
                  props.RPC1[props.selectedField.index].ItemCode &&
