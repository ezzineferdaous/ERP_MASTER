// frontend/src/components/ARGoodsReceiptForm.js
...
import ARGoodsReceiptTable from "./ARGoodsReceiptTable";
...
const ARGoodsReceiptForm = (props) => {
  ...
  useEffect(() => {
    if (!props.OpdnData.DocStatus.trim()) {
      props.setOpdnData((prevFormData) => ({
        ...prevFormData,
        DocStatus: "O",
      }));
    }
  }, [props.OpdnData.DocStatus, props.setOpdnData]);
    ...
    <div>
      <ValidatorForm onSubmit={props.handleSubmit} onError={() => null}>
          ...
          <Grid item lg={4} md={6} sm={12} xs={12}>
            ...
            >
              ...
              <Select
                ...
                name="DocStatus"
                size="small"
                value={props.OpdnData.DocStatus.trim() || "O"}
                onChange={props.handleChange}
                style={{ width: "100%" }}
                inputProps={{ readOnly: true }}
              >
          ...
          <Grid item lg={4} md={6} sm={12} xs={12}> {/* Flatpickr DocDate */}
              <div style={{ position: "relative", width: "100%" }}>
                  <Flatpickr
                      ...
                      value={props.OpdnData.DocDate ? new Date(props.OpdnData.DocDate) : new Date()}
                  ...
                  />
                  <label className="label-flatpickr" style={{top: props.OpdnData.DocDate ? "-10px" : "12px"}} > Date Document </label>
              </div>
          </Grid>
          <Grid item lg={4} md={6} sm={12} xs={12}>
              <div style={{ position: "relative", width: "100%" }}>
                  <Flatpickr
                      className="Flatpickr-flatpickr"
                      data-enable-time={false}
                      value={props.OpdnData.DueDate ? new Date(props.OpdnData.DueDate) : new Date()}
                      onChange={(date) => props.handleChange({  target: { name: "DueDate", value: date[0] }, }) }
                      options={{ dateFormat: "d/m/Y"}}
                      disabled={props.state.Mode === "Mettre à jour" || props.state.Mode === "OK"}
                  />
                  <label className="label-flatpickr" style={{top: props.OpdnData.DueDate ? "-10px" : "12px"}} > Date d'écheance </label>
              </div>
          </Grid>
        </Grid>
        ...
        <ARGoodsReceiptTable
          ...
          Pdn1Data={props.Pdn1Data}
          setPdn1Data={props.setPdn1Data}
          Mode={props.Mode}
          setOpdnData={props.setOpdnData}
          state={props.state}
              ...
              <Grid container>
                <Grid item lg={2} md={6} sm={12} xs={12}>
                  <StyledTextField
                    ...
                    type="text"
                    name="DiscPrcnt"
                    value={props.OpdnData.DiscPrcnt}
                    onChange={props.handleChange}
                ...
                <Grid item lg={9} md={6} sm={12} xs={12}>
                  <StyledTextField
                    ...
                    type="text"
                    name="RemiseTotal"
                    value={props.OpdnData.RemiseTotal}
                    onChange={props.handleChange}
                    onBlur={() => props.handleCalculations2()} 
                    label="Total Remise"
                    fullWidth
...
export default ARGoodsReceiptForm;
