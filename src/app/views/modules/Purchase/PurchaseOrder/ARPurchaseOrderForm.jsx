// frontend/src/components/ARPurchaseOrderForm.js
...
import ARPurchaseOrderTable from "./ARPurchaseOrderTable"; // Import custom component to handle the delivery table
...
const ARPurchaseOrderForm = (props) => {
  ...
  useEffect(() => {
    if (!props.OporData.DocStatus.trim()) {
      props.setOporData((prevFormData) => ({
        ...prevFormData,
        DocStatus: "O",
      }));
    }
  }, [props.OporData.DocStatus, props.setOporData]);
      ...
      <ValidatorForm onSubmit={props.handleSubmit} onError={() => null}>
        ...
        <Grid container spacing={10} style={{ marginTop: "-100px" }}>
          <Grid item lg={4} md={6} sm={12} xs={12}>
            {/* TextField for fournisseur Code, read-only, with icon button for modal */}
            <StyledTextField
              type="text"
              name="CardCode"
              size="small"
              value={props.OporData.CardCode}
          ...
          <Grid item lg={4} md={6} sm={12} xs={12}>
            ...
            >
              ...
              <Select
                ...
                name="DocStatus"
                size="small"
                value={props.OporData.DocStatus.trim() || "O"}
                onChange={props.handleChange}
                style={{ width: "100%" }}
                inputProps={{ readOnly: true }}
              >
          ...
          <Grid item lg={4} md={6} sm={12} xs={12}> {/* Flatpickr DocDate */}
              <div style={{ position: "relative", width: "100%" }}>
                  <Flatpickr
                      ...
                      value={props.OporData.DocDate ? new Date(props.OporData.DocDate) : new Date()}
                  ...
                  />
                  <label className="label-flatpickr" style={{top: props.OporData.DocDate ? "-10px" : "12px"}} > Date Document </label>
              </div>
          </Grid>
          <Grid item lg={4} md={6} sm={12} xs={12}>
              <div style={{ position: "relative", width: "100%" }}>
                  <Flatpickr
                      className="Flatpickr-flatpickr"
                      data-enable-time={false}
                      value={props.OporData.DueDate ? new Date(props.OporData.DueDate) : new Date()}
                      onChange={(date) => props.handleChange({  target: { name: "DueDate", value: date[0] }, }) }
                      options={{ dateFormat: "d/m/Y"}}
                      disabled={props.state.Mode === "Mettre à jour" || props.state.Mode === "OK"}
                  />
                  <label className="label-flatpickr" style={{top: props.OporData.DueDate ? "-10px" : "12px"}} > Date d'écheance </label>
              </div>
          </Grid>
        </Grid>
        {/* ARPurchaseOrderTable component for managing delivery lines */}
        <ARPurchaseOrderTable
          ...
          Por1Data={props.Por1Data}
          setPor1Data={props.setPor1Data}
          Mode={props.Mode}
          setOporData={props.setOporData}
          state={props.state}
              ...
              <Grid container>
                <Grid item lg={2} md={6} sm={12} xs={12}>
                  <StyledTextField
                    ...
                    type="text"
                    name="DiscPrcnt"
                    value={props.OporData.DiscPrcnt}
                    onChange={props.handleChange}
                ...
                <Grid item lg={9} md={6} sm={12} xs={12}>
                  <StyledTextField
                    ...
                    type="text"
                    name="RemiseTotal"
                    value={props.OporData.RemiseTotal}
                    onChange={props.handleChange}
                    onBlur={() => props.handleCalculations2()} 
                    label="Total Remise"
                    fullWidth
...
export default ARPurchaseOrderForm;
