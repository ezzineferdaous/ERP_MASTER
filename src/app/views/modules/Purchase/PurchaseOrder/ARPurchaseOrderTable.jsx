...
// ARPurchaseOrderTable component
const ARPurchaseOrderTable = React.memo((props) => {
  ...
  const handleCalculations = (lineNum) => {
    props.setPor1Data((prevPor1) => {
      const index = prevPor1.findIndex((row) => row.LineNum === lineNum);

      if (index === -1) return prevPor1;

      const updatedRow = { ...prevPor1[index] };

      if (!updatedRow.isManual) {
        console.log(
          "handleCalculations - isManual is false, skipping calculations"
        );
        return prevPor1;
      }
      ...
      console.log("handleCalculations - updated row:", prevPor1);
      prevPor1[index] = updatedRow;
  ...
  const handleInputChange = useCallback(
    (lineNum, event) => {
      ...
      console.log("handleInputChange :", props.Por1);
    },
    [props.setPor1Data]
  );
  ...
  // Update line numbers for all entries in Por1Data
  useEffect(() => {
    props.setPor1Data((prevIge12) =>
  ...
  const POR1D = () => {
    if (props.allFieldsFilled()) {
      ...
      props.setPor1Data([
        ...
        {
          DocEntry: "",
          LineNum: props.Por1Data.length + 1, // Set the line number for the new entry
          ItemCode: "",
          ItemName: "",
          Quantity: 1,
          WhsCode: "",
  ...
  const handleDelete = (index) => {
    ...
    const updatedDLN1 = [...props.Por1Data]; // Clone the data
    updatedDLN1.splice(index, 1); // Remove the selected row
    props.setPor1Data(updatedDLN1); // Update the state
  ...
  const handleEdit = (index, fieldName) => {
    ...
    if (props.Por1Data[index].isEditing || props.state.Mode !== "Créer") {
      return;
    }

    if (props.allFieldsFilled()) {
      const updatedRows = props.Por1Data.map((row, rowIndex) => ({
        ...row,
        isEditing: rowIndex === index,
      }));
      props.setPor1Data(updatedRows);
    ...
    <Box>
      ...
      >
        <Table border="1" style={{ width: "100%", tableLayout: "fixed" }}>
          ...
          <TableBody>
            {props.Por1Data.map((dln, index) => (
              // <TableRow
              //   key={index}
              //   onClick={(e) =>
              //     handleEdit(
              //       index,
              //       e.target.dataset.field || e.currentTarget.dataset.field
              //     )
              //   }
                ...
                {dln.isEditing ? (
                  <>
                    ...
                    <StyledTableCell>
                      ...
                      >
                        <TextField
                          ...
                          data-index={index}
                          inputRef={(el) =>
                            (inputRefs.current[`ItemCode-${index}`] = el)
                          }
                    ...
                    <StyledTableCell>
                      ...
                      >
                        <TextField
                          ...
                          data-index={index}
                          inputRef={(el) =>
                            (inputRefs.current[`ItemName-${index}`] = el)
                          }
                          onChange={(e) => handleInputChange(index, e)}
                    ...
                    <StyledTableCell>
                      ...
                      >
                        <TextField
                          ...
                          value={dln.WhsCode}
                          inputRef={(el) =>
                            (inputRefs.current[`WhsCode-${index}`] = el)
                          }
                          data-index={index}
                          onChange={(e) => handleInputChange(index, e)}
                          disabled={!dln.ItemCode}
                    ...
                    <StyledTableCell>
                      <TextField
                        ...
                        data-index={index}
                        inputRef={(el) =>
                          (inputRefs.current[`PriceHT-${index}`] = el)
                        }
                    ...
                    <StyledTableCell>
                      <TextField
                        ...
                        data-index={index}
                        inputRef={(el) =>
                          (inputRefs.current[`Discount-${index}`] = el)
                        }
                    ...
                    <StyledTableCell>
                      <FormControl fullWidth>
                        <Select
                          ...
                          data-index={index}
                          inputRef={(el) =>
                            (inputRefs.current[`VAT-${index}`] = el)
                          }
                    ...
                    <StyledTableCell>
                      <TextField
                        ...
                        data-index={index}
                        inputRef={(el) =>
                          (inputRefs.current[`Price-${index}`] = el)
                        }
                        onChange={(e) => {
                          handleInputChange(index, e);
                        }}
                    ...
                    <StyledTableCell>
                      <TextField
                        ...
                        data-index={index}
                        inputRef={(el) =>
                          (inputRefs.current[`LineHT-${index}`] = el)
                        }
                        value={dln.LineHT}
                        onChange={(e) => {
                          handleInputChange(index, e);
                    ...
                    <StyledTableCell>
                      <TextField
                        ...
                        data-index={index}
                        inputRef={(el) =>
                          (inputRefs.current[`LineTotal-${index}`] = el)
                        }
                        value={dln.LineTotal}
                        onChange={(e) => {
                          handleInputChange(index, e);
                  ...
                  <>
                    ...
                    <StyledTableCell
                      ...
                      style={{ textAlign: "center" }}
                    >
                      {props.vatOptions.find(
                        (option) => option.Rate === dln.VAT
                      )?.Name || dln.VAT}
                    </StyledTableCell>
                    <StyledTableCell
                      data-field="Price"
                          ...
                          <FormControlLabel
                            control={
                              <Checkbox
                                ...
                                disabled={
                                  props.selectedField.name === "ItemCode" &&
                                  props.Por1Data[props.selectedField.index] &&
                                  props.Por1Data[props.selectedField.index]
                                    .ItemCode &&
...
export default ARPurchaseOrderTable;
