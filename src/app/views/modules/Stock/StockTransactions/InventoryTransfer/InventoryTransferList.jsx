...
// const GoodsIssueList = ({ setWTR1, setEditIndex,state,setState, Owtr, setOwtr, setshowListOwtr }) => {
...
//     try {
//       setEditIndex();
//       setOwtr(row.original);
//       const WTR1Response = await axiosInstance.get(`WTR1/data/Min/${row.original.DocEntry}`);
//       setWTR1(WTR1Response.data);
...
//         const res = await axiosInstance.get("OWTR/");
//         setData(res.data);
...
const GoodsIssueList = ({setWTR1, setState ,state,OWTR, setOwtr, setshowListOige }) => {
