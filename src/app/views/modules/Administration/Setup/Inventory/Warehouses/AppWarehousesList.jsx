...
const AppForm = ({ setWarehouse, setshowWarehouse }) => {
  ...
  const columns = useMemo(
    () => [
      { accessorKey: 'CodeWarehouse', header: 'Code', size: 100 },
      { accessorKey: 'NomWarehouse', header: 'Nom Magasin', size: 400 },
      { accessorKey: 'Rue', header: 'Rue', size: 100 },
      { accessorKey: 'NumRue', header: 'N° Rue', size: 100 },
      { accessorKey: 'CountryCode', header: 'Pays', size: 100 },
      { accessorKey: 'City', header: 'Ville', size: 100 },
      {
        id: 'Afficher',
        header: 'Afficher',
        size: 250,
